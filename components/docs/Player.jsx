      ...
      <div className="flex flex-wrap mx-[-15px]">
        ...
        <div className="xl:w-8/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!order-2">
          <section id="snippet-1" className="wrapper pt-24">
            <h2 className="!mb-5 !leading-[1.35]">HTML5 Video - plyr</h2>
            <div className="card">
                  ...
                  <div className="code-wrapper relative !mb-0">
                    <div className="code-wrapper-inner">
                      <pre className="language-html">
                        <code>
                          &lt;video poster="/assets/img/photos/movie.jpg"
                          className="player" playsinline controls
                          preload="none"&gt;
                          {"\n"}
                          {"  "}&lt;source src="/assets/media/movie.mp4"
                          type="video/mp4"&gt;{"\n"}&lt;/video&gt;
                        </code>
                      </pre>
                    </div>
          ...
          <section id="snippet-2" className="wrapper pt-24">
            <h2 className="!mb-5 !leading-[1.35]">Vimeo - plyr</h2>
            <div className="card">
              <div className="card-body flex-[1_1_auto] p-[40px]">
                <div
                  className="player relative z-[2] rounded-[0.4rem]"
                ...
                >
                  <div className="code-wrapper relative !mb-0">
                    <div className="code-wrapper-inner">
                      <pre className="language-html">
                        <code>
                          &lt;div className="player" data-plyr-provider="vimeo"
                          data-plyr-embed-id="15801179"&gt;&lt;/div&gt;
                        </code>
                      </pre>
                    </div>
                    {/*/.code-wrapper-inner */}
          ...
          <section id="snippet-3" className="wrapper pt-24">
            <h2 className="!mb-5 !leading-[1.35]">YouTube - plyr</h2>
            <div className="card">
              <div className="card-body flex-[1_1_auto] p-[40px]">
                <div
                  className="player relative z-[2] rounded-[0.4rem]"
                    ...
                    <div className="code-wrapper-inner">
                      <pre className="language-html">
                        <code>
                          ...
                          data-plyr-provider="youtube"
                          data-plyr-embed-id="j_Y2Gwaj7Gs"&gt;&lt;/div&gt;
                        </code>
                      </pre>
                    </div>
                    {/*/.code-wrapper-inner */}
          ...
          <section id="snippet-4" className="wrapper py-24">
            <h2 className="!mb-5 !leading-[1.35]">Responsive Embed</h2>
            <div className="card">
              <div className="card-body flex-[1_1_auto] p-[40px]">
                <div className="ratio ratio-16x9 aspect-video relative w-full">
                  <iframe
                    className="rounded absolute w-full h-full left-0 top-0"
                ...
                >
                  <div className="code-wrapper relative !mb-0">
                    <div className="code-wrapper-inner">
                      <pre className="language-html">
                        <code>
                          &lt;div className="ratio ratio-16x9 aspect-video"&gt;
                          {"\n"}
                          {"  "}ANY EMBED CODE (IFRAME, EMBED, OBJECT from
                          YOUTUBE, VIMEO ETC.){"\n"}&lt;/div&gt;{"\n"}
                          &lt;!--/.ratio --&gt;
                        </code>
                      </pre>
