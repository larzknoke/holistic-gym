          ...
          <div className="flex flex-wrap mx-0 items-center">
            ...
            >
              <div className="!relative">
                ...
                <figure className="!rounded-md !shadow-lg">
                  <div className="hover:cursor-pointer hover:shadow-lg hover:translate-y-[-0.25rem] transition-all duration-[0.2s] ease-in-out motion-reduce:transition-none bg-gym-danger text-white text-center px-5 py-2 rounded absolute -top-12 right-4 z-[2] text-xl shadow-sm rotate-2 font-bold">
