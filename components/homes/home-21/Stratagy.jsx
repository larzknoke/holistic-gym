...
export default function Stratagy() {
  return (
    <section className="wrapper !bg-[#ffffff]">
      <div className="container pb-[4.5rem] xl:pb-28 lg:pb-28 md:pb-28">
        <div className="flex flex-wrap mx-[-15px] md:mx-[-20px] lg:mx-[-20px] xl:mx-[-35px] !mt-[-50px] items-center">
          <div className="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] !px-[15px] md:!px-[20px] lg:!px-[20px] xl:!px-[35px] !mt-[50px] max-w-full xl:!order-2 lg:!order-2">
            <div className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lg:!mr-6 xl:!mr-6">
              <div className="card-body p-6">
                <div className="flex flex-row">
                  <div>
                    <span className="icon btn btn-circle btn-lg btn-soft-sky pointer-events-none !mr-4 xl:!text-[1.3rem] !w-12 !h-12 !text-[calc(1.255rem_+_0.06vw)] inline-flex items-center justify-center leading-none !p-0 !rounded-[100%]">
            ...
            {/*/.card */}
            <div className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lg:!ml-16 xl:!ml-16 !mt-6">
              <div className="card-body p-6">
                <div className="flex flex-row">
                  <div>
                    <span className="icon btn btn-circle btn-lg btn-soft-sky pointer-events-none !mr-4 xl:!text-[1.3rem] !w-12 !h-12 !text-[calc(1.255rem_+_0.06vw)] inline-flex items-center justify-center leading-none !p-0 !rounded-[100%]">
            ...
            {/*/.card */}
            <div className="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] lg:mx-6 xl:mx-6 !mt-6">
              <div className="card-body p-6">
                <div className="flex flex-row">
                  <div>
                    <span className="icon btn btn-circle btn-lg btn-soft-sky pointer-events-none !mr-4 xl:!text-[1.3rem] !w-12 !h-12 !text-[calc(1.255rem_+_0.06vw)] inline-flex items-center justify-center leading-none !p-0 !rounded-[100%]">
