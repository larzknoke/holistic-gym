...
import FontIcons from "@/components/docs/FontIcons";

export const metadata = {
  title:
    "Icons Font || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageIconsFont() {
  return (
    <>
