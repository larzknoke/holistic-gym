...
import Ilastrations from "@/components/docs/Ilastrations";

export const metadata = {
  title:
    "Illustrations || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageIllustrations() {
  return (
    <>
      <div className="grow shrink-0">
        ...
        />
        <PageTitle pagename="Illustrations" />
        <Ilastrations />
