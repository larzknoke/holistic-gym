...
import Backgrounds from "@/components/docs/Backgrounds";

export const metadata = {
  title:
    "Backgrounds || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageBackgrounds() {
  return (
    <>
      <div className="grow shrink-0">
        ...
        />
        <PageTitle pagename="Backgrounds" />
        <Backgrounds />
