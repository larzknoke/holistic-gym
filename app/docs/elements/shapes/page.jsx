...
import Shapes from "@/components/docs/Shapes";

export const metadata = {
  title:
    "Shapes || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageShapes() {
  return (
    <>
