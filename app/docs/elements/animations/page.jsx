...
import Animation from "@/components/docs/Animation";

export const metadata = {
  title:
    "Animations || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageAnimations() {
  return (
    <>
