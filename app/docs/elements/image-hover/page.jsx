...
import ImageHover from "@/components/docs/ImageHover";

export const metadata = {
  title:
    "Image Hover || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageImageHover() {
  return (
    <>
      <div className="grow shrink-0">
        ...
        />
        <PageTitle pagename="Image Hover" />
        <ImageHover />
