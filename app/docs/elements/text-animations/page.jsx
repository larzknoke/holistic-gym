...
import TextAnimations from "@/components/docs/TextAnimations";

export const metadata = {
  title:
    "Text Animations || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageTextAnimations() {
  return (
    <>
      <div className="grow shrink-0">
        ...
        />
        <PageTitle pagename="Text Animations" />
        <TextAnimations />
