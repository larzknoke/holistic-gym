...
import Tooltips from "@/components/docs/Tooltips";

export const metadata = {
  title:
    "Tooltips and Popovers || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageTooltipAndPopovers() {
  return (
    <>
      <Header32
      ...
      <div className="grow shrink-0">
        <PageTitle pagename="Tooltips and Popovers" />
        <Tooltips />
