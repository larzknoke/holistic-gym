...
import Carousel from "@/components/docs/Carousel";

export const metadata = {
  title:
    "Carousel || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageCarousel() {
  return (
    <>
