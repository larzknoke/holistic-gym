...
import TextHightlight from "@/components/docs/TextHightlight";

export const metadata = {
  title:
    "Text Hignlights || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageTextHighlight() {
  return (
    <>
      <div className="grow shrink-0">
        ...
        />
        <PageTitle pagename="Text Highlights" />
        <TextHightlight />
