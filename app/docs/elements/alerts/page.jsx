...
import Alerts from "@/components/docs/Alerts";

export const metadata = {
  title:
    "Alerts || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageAlerts() {
  return (
    <>
