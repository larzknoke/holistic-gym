...
import Accordions from "@/components/docs/Accordions";

export const metadata = {
  title:
    "Accordions || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageAccordion() {
  return (
    <>
