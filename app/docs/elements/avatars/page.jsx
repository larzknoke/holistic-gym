...
import Avatars from "@/components/docs/Avatars";

export const metadata = {
  title:
    "Avatars || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageAvatars() {
  return (
    <>
