...
import FormElements from "@/components/docs/FormElements";

export const metadata = {
  title:
    "Form Elements || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageFormElements() {
  return (
    <>
      <div className="grow shrink-0">
        ...
        />
        <PageTitle pagename="Form Elements" />
        <FormElements />
