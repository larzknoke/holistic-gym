...
import Tables from "@/components/docs/Tables";

export const metadata = {
  title:
    "Tables || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageTables() {
  return (
    <>
