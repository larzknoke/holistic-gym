...
import Dividers from "@/components/docs/Dividers";

export const metadata = {
  title:
    "Dividders || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPageDividers() {
  return (
    <>
