...
import Player from "@/components/docs/Player";

export const metadata = {
  title:
    "Player || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
  description:
    "Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
};
export default function DocsPagePlayer() {
  return (
    <>
